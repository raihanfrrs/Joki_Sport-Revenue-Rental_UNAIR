...
<div class="container-xxl flex-grow-1 container-p-y">
    <form action="{{ route('data.master.gor.update', $gor->slug) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row">
                ...
                <div class="card">
                    ...
                    <h5 class="card-title">Tambah Foto Gor</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control @error('gor_image') is-invalid @enderror" id="photo" name="gor_image" onchange="previewImageProperty()">
                                <div class="col-12">
