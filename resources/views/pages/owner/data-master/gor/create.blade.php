...
<form action="{{ route('master.gor.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">Tambah Identitas Gor</h5>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select name="type_duration" id="type_duration" class="form-select text-capitalize">
                                <option value="hours" {{ old('type_duration') == 'hours' ? 'selected' : '' }}>Per-Jam</option>
                                <option value="in" {{ old('type_duration') == 'in' ? 'selected' : '' }}>Sekali Masuk</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea name="address" id="address" cols="10" rows="5" class="form-control">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea name="standard" id="standard" cols="10" rows="5" class="form-control">{{ old('standard') }}</textarea>
                            @error('standard')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
            ...
            <div class="card">
                ...
                <h5 class="card-title">Tambah Foto Gor</h5>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="file" class="form-control @error('gor_image') is-invalid @enderror" id="gor" name="gor_image" onchange="previewImage()" required>
                            <div class="col-12">
