...
$(function () {
  ...
  var dt_gor_table = $('#listFieldCategoriesTable');

  if (dt_gor_table.length) {
    dt_gor_table.DataTable({
      ajax: "/listFieldCategoriesTable",
      columns: [
        { data: '' },
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Tambah Kategori Lapangan Baru</span>',
  ...
  $(document).on('click', '#button-delete-category', function () {
    ...
    let formSelector = ".form-delete-category-" + slug;
