...
$(function () {
  ...
  var dt_gor_table = $('#listMasterOwnersTable');

  if (dt_gor_table.length) {
    dt_gor_table.DataTable({
      ajax: "/listMasterOwnersTable",
      columns: [
        { data: '' },
        { data: 'name' },
        { data: 'email' },
        ...
        { data: 'total_gor', class: 'text-center' },
  ...
  // Delete Record
  $(document).on('click', '#button-data-master-delete-owner', function () {
    let slug = $(this).attr('data-slug');
    let formSelector = ".form-data-master-delete-owner-" + slug;
  ...
  $(document).on('click', '#button-data-master-update-owner-status', function (e) {
    e.preventDefault();
    let slug = $(this).attr('data-slug');
    let name = $(this).attr('data-name');
    let formSelector = ".form-data-master-update-owner-status-" + slug;
