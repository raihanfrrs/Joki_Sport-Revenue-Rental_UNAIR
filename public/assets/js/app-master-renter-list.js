...
$(function () {
  ...
  var dt_gor_table = $('#listMasterRentersTable');

  if (dt_gor_table.length) {
    dt_gor_table.DataTable({
      ajax: "/listMasterRentersTable",
      columns: [
        { data: '' },
        { data: 'name' },
        { data: 'email' },
        ...
        { data: 'total_order', class: 'text-center' },
        { data: 'status' },
        { data: 'action' }
      ],
      columnDefs: [
  ...
  // Delete Record
  $(document).on('click', '#button-data-master-delete-renter', function () {
    let slug = $(this).attr('data-slug');
    let formSelector = ".form-data-master-delete-renter-" + slug;
  ...
  $(document).on('click', '#button-data-master-update-renter-status', function (e) {
    e.preventDefault();
    let slug = $(this).attr('data-slug');
    let name = $(this).attr('data-name');
    let formSelector = ".form-data-master-update-renter-status-" + slug;

    Swal.fire({
      title: 'Apakah anda yakin?',
      text: name+" akan tidak bisa login!",
      icon: 'warning',
      showCancelButton: true,
      cancelButtonText: 'Batal',
      confirmButtonText: 'Ya, Hapus!',
